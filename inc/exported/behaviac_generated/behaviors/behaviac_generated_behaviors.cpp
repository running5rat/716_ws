...
namespace behaviac
{
	...
	public:
		...
		{
			Workspace::GetInstance()->RegisterBehaviorTreeCreator("Behavior", bt_Behavior::Create);
			Workspace::GetInstance()->RegisterBehaviorTreeCreator("Interact", bt_Interact::Create);
		}
	};
